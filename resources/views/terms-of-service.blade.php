...
<body class="bg-gray-200">
    <div class="bg-blue-800 h-32 w-full px-40 py-6 text-white">
        ...
        <p>Terms and Conditions of https://socialite-oauth.herokuapp.com
        </p>
    </div>
    <div class="mx-40 px-8 py-8 bg-white">
        <h1 class="text-3xl py-4">Terms and Conditions</h1>

        <p>Last updated: July 17, 2020</p>

        <p>Please read these terms and conditions carefully before using Our Service.</p>

        <h1 class="text-3xl py-4">Interpretation and Definitions</h1>
        <h2 class="text-2xl py-4">Interpretation</h2>
        ...
        <h2 class="text-2xl py-4">Definitions</h2>
        ...
        <ul class="list-disc pl-8">
            ...
            <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that
                form
                the entire agreement between You and the Company regarding the use of the Service. This Terms and
                Conditions
                agreement is maintained by the <a
                    href="https://www.privacypolicies.com/terms-conditions-generator/">Terms
            ...
            <li><strong>Website</strong> refers to Socialite OAuth, accessible from
                https://socialite-oauth.herokuapp.com/
            </li>
        ...
        <h1 class="text-3xl py-4">Your Accounts</h1>
        <p>
            ...
            accurate information about yourself. Don’t try to impersonate anyone else when you create your account. If
            your information changes at any time, please update your account to reflect those changes.

            In some cases, an account may be assigned to you by an administrator, such as your employer or educational
            institution. If you are using or logging into an account assigned to you by an administrator, additional
            terms may apply to your use of the Sites. Moreover, your administrator may be able to access or disable your
            account without our involvement.

            You may not share your account with anyone else. Please keep your password confidential, and try not to use
            it on other websites. If you believe that your account has been compromised at any time, please notify your
            system administrator.
        </p>

        <h1 class="text-3xl py-4">Acknowledgement</h1>
        ...
        <h1 class="text-3xl py-4">Links to Other Websites</h1>
        ...
        <h1 class="text-3xl py-4">Termination</h1>
        ...
        <h1 class="text-3xl py-4">Limitation of Liability</h1>
        ...
        <h1 class="text-3xl py-4">"AS IS" and "AS AVAILABLE" Disclaimer</h1>
        <p>The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of
            any
            kind. To the maximum extent permitted under applicable law, the Company, on its own behalf and on behalf of
            its
            ...
            warranties
            of merchantability, fitness for a particular purpose, title and non-infringement, and warranties that may
            arise
            out of course of dealing, course of performance, usage or trade practice. Without limitation to the
            foregoing,
            the Company provides no warranty or undertaking, and makes no representation of any kind that the Service
            will
        ...
        <h1 class="text-3xl py-4">Governing Law</h1>
        ...
        <h1 class="text-3xl py-4">Disputes Resolution</h1>
        ...
        <h1 class="text-3xl py-4">For European Union (EU) Users</h1>
        ...
        <h1 class="text-3xl py-4">United States Legal Compliance</h1>
        ...
        <h1 class="text-3xl py-4">Severability and Waiver</h1>
        <h2 class="text-2xl py-4">Severability</h2>
        ...
        <h2 class="text-2xl py-4">Waiver</h2>
        ...
        <h1 class="text-3xl py-4">Translation Interpretation</h1>
        ...
        <h1 class="text-3xl py-4">Changes to These Terms and Conditions</h1>
        ...
        <h1 class="text-3xl py-4">Contact Us</h1>
        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>

        <ul class="list-disc pl-8">
            <li>By email: aleedhx@gmail.com</li>
        </ul>
    </div>
</body>
