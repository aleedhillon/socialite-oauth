...
<body class="bg-gray-200">
    ...
    <div class="mx-40 px-8 py-8 bg-white">
        <h1 class="text-3xl py-4">Privacy Policy</h1>
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            use of information in accordance with this Privacy Policy. This Privacy Policy is maintained by the <a
                href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
        ...
        <h1 class="text-3xl py-4">Collecting and Using Your Personal Data</h1>
        <h2 class="text-2xl py-4">Types of Data Collected</h2>

        <h3 class="text-xl my-4">Personal Data</h3>
        ...
        <h3 class="text-xl my-4">Usage Data</h3>
        ...
        <h3 class="text-xl my-4">Tracking Technologies and Cookies</h3>
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or
            ...
            more
            about cookies in the <a href="https://www.privacypolicies.com/blog/cookies/">"What Are Cookies"</a> article.
        </p>
        ...
        <h2 class="text-2xl py-4">Use of Your Personal Data</h2>
        ...
        <h2 class="text-2xl py-4">Retention of Your Personal Data</h2>
        ...
        <h2 class="text-2xl py-4">Transfer of Your Personal Data</h2>
        ...
        <h2 class="text-2xl py-4">Disclosure of Your Personal Data</h2>
        <h3 class="text-xl my-4">Business Transactions</h3>
        ...
        <h3 class="text-xl my-4">Law enforcement</h3>
        ...
        <h3 class="text-xl my-4">Other legal requirements</h3>
        ...
        <h2 class="text-2xl py-4">Security of Your Personal Data</h2>
        ...
        <h1 class="text-3xl py-4">Children's Privacy</h1>
        ...
        <h1 class="text-3xl py-4">Changes to this Privacy Policy</h1>
